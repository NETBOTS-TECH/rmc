    ...
    const fetchServices = async () => {
      try {
        ...
        const res = data.filter(
          (service: { category: string }) => service.category === "residential"
        );
        ...
        setCommercialServices(
          data.filter(
            (service: { category: string }) => service.category === "commercial"
          )
        );
      } catch (error) {
        ...
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-6">
              ...
              <div key={item.id} className="relative group">
                {item.hasDropdown ? (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      align="start"
                      className="horizontal-dropdown p-4"
                    >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="p-4 w-[800px]">
                {" "}
                {/* Wider dropdown for 4 columns */}
                <div className="grid grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    {residentialServices
                      .filter(
                        (service: any) =>
                          service.subheading === "CONCRETE REPAIR"
                      )
                      .map((service: any) => (
                  ...
                  <div>
                    ...
                    {residentialServices
                      .filter(
                        (service: any) =>
                          service.subheading === "FOUNDATION REPAIR"
                      )
                      .map((service: any) => (
                        <DropdownMenuItem key={service._id} asChild>
                          <Link
                  ...
                  <div>
                    ...
                    {residentialServices
                      .filter(
                        (service: any) => service.subheading === "NEW CONCRETE"
                      )
                      .map((service: any) => (
                        <DropdownMenuItem key={service._id} asChild>
                          <Link
                  ...
                  <div>
                    ...
                    {residentialServices
                      .filter(
                        (service: any) => service.subheading === "WATERPROOFING"
                      )
                      .map((service: any) => (
                        <DropdownMenuItem key={service._id} asChild>
                          <Link
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    {commercialServices
                      .filter(
                        (service: any) =>
                          service.subheading === "COMMERCIAL SERVICES"
                      )
                      .map((service: any) => (
                        <DropdownMenuItem key={service._id} asChild>
                          <Link
                  ...
                  <div>
                    ...
                    {commercialServices
                      .filter(
                        (service: any) =>
                          service.subheading === "PARTNERED INDUSTRIES"
                      )
                      .map((service: any) => (
                        <DropdownMenuItem key={service._id} asChild>
                          <Link
                  ...
                  <div>
                    ...
                    {commercialServices
                      .filter(
                        (service: any) =>
                          service.subheading === "PREMIER PARTNER"
                      )
                      .map((service: any) => (
                        <DropdownMenuItem key={service._id} asChild>
                          <Link
          ...
          <div className="absolute top-full left-0 w-full bg-white shadow-md lg:hidden">
            <div className="flex flex-col space-y-4 p-4">
              ...
              <button
                ...
                className="flex items-center justify-between text-gray-700 hover:text-primary font-medium transition-colors"
              >
                Residential Services
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${
                    isResidentialOpen ? "rotate-180" : ""
                  }`}
                />
              </button>
              {isResidentialOpen && (
